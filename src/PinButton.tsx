...
import { StyleSheet, Text, TextStyle, ViewStyle, TouchableOpacity,Image } from 'react-native';
import { DEFAULT } from './types';
const image = require("../../../../assets/icons/fingerprint.png")
const PinButton = ({
    value, style, textStyle, disabled = false, backSpace, backSpaceText, onPress,icon=false,handleBio
}: {
    value: string;
    disabled?: boolean;
